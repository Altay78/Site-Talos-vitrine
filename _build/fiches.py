...
COMMERCIAL = dict(
 ...
 cartes=[
  dict(role=u"Réception", lab=u"Capter la demande",
       ...
       para=u"Mail, formulaire du site, WhatsApp ou appel manqué : la demande est prise en "
            u"charge, qualifiée, puis rangée au bon endroit avant que vous rentriez.",
       puces=[('clock', u"Répond aux demandes reçues le soir et le week-end"),
              ('chat', u"Pose les questions qui manquent au dossier"),
              ('pin', u"Récupère chantier, adresse, délai et budget évoqué"),
              ('msg', u"Rassemble mail, formulaire et WhatsApp au même endroit"),
              ('bell', u"Vous prévient quand une demande mérite votre appel")],
  ...
  dict(role=u"Chiffrage", lab=u"Préparer le devis",
       ...
       para=u"Un mail, une note vocale dictée en sortant du chantier, une photo du relevé : "
            u"le devis sort chiffré sur vos prix, jamais sur une moyenne du marché.",
       puces=[('msg', u"Depuis un e-mail client, sans une seule ressaisie"),
              ('voice', u"Depuis une note vocale dictée sur place"),
              ('cam', u"Depuis une photo : plan, relevé, devis concurrent"),
              ('doc', u"Depuis le formulaire de votre site, déjà structuré"),
              ('grille', u"Chiffrage sur votre grille tarifaire, vos marges comprises")],
  ...
  dict(role=u"Signature", lab=u"Envoyer &amp; faire signer",
       ...
       para=u"Trois variantes, une date de validité, des conditions claires. Le client choisit "
            u"son niveau de prestation au lieu de choisir un concurrent.",
       puces=[('grid', u"Trois variantes Éco, Standard, Premium"),
              ('edit', u"Signature électronique depuis le téléphone du client"),
              ('bag', u"Demande d'acompte de 30 % au moment de la signature"),
              ('cal', u"Date de validité sur chaque devis, l'urgence sans vous"),
              ('doc', u"Conditions de paiement et retenue de garantie posées")],
  ...
  dict(role=u"Relance", lab=u"Relancer &amp; suivre",
       ...
       para=u"La séquence s'adapte à la réaction du client et se coupe dès qu'il répond. "
            u"Personne n'est harcelé en votre nom.",
       puces=[('loop', u"Relance à J+3, courte et polie"),
              ('chat', u"Relance à J+7, avec proposition d'échange de vive voix"),
              ('cal', u"Relance à J+14, avec la date de validité en rappel"),
              ('shield', u"Arrêt immédiat dès que le client répond"),
              ('send', u"Arrêt à la signature — la facture prend le relais"),
              ('search', u"Détection des devis relus plusieurs fois"),
              ('star', u"Les dossiers chauds remontent en haut de votre pile")],
...
TRESORERIE = dict(
 ...
 cartes=[
  dict(role=u"Détection", lab=u"Repérer les retards",
       ...
       para=u"La facture bascule seule dans les impayés, avec son ancienneté, le montant en "
            u"jeu et l'historique du client. Votre banque est lue, jamais pilotée.",
       puces=[('clock', u"Détection dès l'échéance dépassée"),
              ('chart', u"Classement par ancienneté et par montant"),
              ('lock', u"Rapprochement bancaire en lecture seule"),
              ('shield', u"Arrêt automatique dès que le virement arrive"),
              ('user', u"Historique de paiement client par client")],
       cta=u"Voir le scénario complet", href=u"#scenario"),
  dict(role=u"Relance", lab=u"Relancer sans s'énerver",
       ...
       para=u"Chaque relance est écrite à l'avance et attend votre validation. Vous gardez la "
            u"main sur le ton, sur le moment et sur les clients à ménager.",
       puces=[('msg', u"Relance à J+7, courtoise — celle qui suffit le plus souvent"),
              ('loop', u"Relance à J+15, plus directe, facture en pièce jointe"),
              ('bell', u"Relance à J+30, dernier rappel avant procédure"),
              ('filter', u"Seuil d'escalade : en dessous, on n'insiste pas"),
              ('user', u"Mise en pause d'un client sans le sortir du suivi")],
       cta=u"Ne plus relancer moi-même", href=u"reserver.html"),
  dict(role=u"Recouvrement", lab=u"Sortir le vocabulaire légal",
       ...
       para=u"Les pénalités de retard et l'indemnité de 40 € vous sont dues de plein droit "
            u"entre professionnels. Encore faut-il les réclamer — c'est son travail.",
       puces=[('grille', u"Calcul des pénalités au taux légal, jour par jour"),
              ('bag', u"Indemnité forfaitaire de 40 € sur chaque facture en retard"),
              ('doc', u"Mise en demeure prête, facture jointe, mentions légales posées"),
              ('cal', u"Proposition d'échéancier en trois ou quatre fois"),
              ('info', u"Pénalités annoncées dès le deuxième niveau")],
  ...
  dict(role=u"Prévision", lab=u"Voir venir",
       ...
       para=u"La projection part de vos devis signés et de vos factures émises. Vous voyez le "
            u"creux arriver plusieurs semaines avant d'y être.",
       puces=[('chart', u"Projection des encaissements, semaine par semaine"),
              ('bell', u"Alerte hebdomadaire par e-mail et SMS"),
              ('clock', u"Signal quand le solde prévu passe sous votre seuil"),
              ('star', u"Les dossiers à traiter en priorité, montant en tête")],
...
CLIENT = dict(
 ...
 cartes=[
  dict(role=u"Réponse", lab=u"Répondre 24 h/24",
       ...
       para=u"Elle répond dans le périmètre que vous lui avez donné : vos prestations, votre "
            u"zone, vos délais. Hors de ce cadre, elle vous passe la main avec le contexte.",
       puces=[('chat', u"Réponse hors horaires, le week-end et pendant les congés"),
              ('doc', u"Réponses tirées de votre base de connaissances"),
              ('lock', u"Aucun prix ferme sans votre validation"),
              ('msg', u"E-mail, formulaire du site, WhatsApp et SMS"),
              ('user', u"Transfert vers vous dès que la demande sort du cadre")],
       cta=u"Voir le scénario complet", href=u"#scenario"),
  dict(role=u"Qualification", lab=u"Poser les bonnes questions",
       ...
       para=u"Nature des travaux, adresse, urgence, budget évoqué. Et la vérification qui "
            u"évite la matinée perdue : le chantier est-il dans votre secteur ?",
       puces=[('filter', u"Classement par type : urgence, devis, renseignement, suivi"),
              ('pin', u"Vérification de la zone d'intervention"),
              ('info', u"Collecte des informations manquantes, poliment"),
              ('user', u"Création de la fiche client avec son canal préféré"),
              ('bell', u"Remontée immédiate des urgences réelles")],
  ...
  dict(role=u"Agenda", lab=u"Caler le rendez-vous",
       ...
       para=u"Deux ou trois créneaux tirés de votre agenda réel, avec de la marge entre deux "
            u"interventions selon la distance. Une journée qui tient debout.",
       puces=[('cal', u"Proposition de créneaux depuis votre agenda réel"),
              ('pin', u"Temps de trajet pris en compte entre deux chantiers"),
              ('grid', u"Ajout dans Google Agenda ou Outlook, adresse et motif inclus"),
              ('send', u"Récapitulatif envoyé au client dans la foulée"),
              ('lock', u"Aucun rendez-vous hors de votre zone")],
  ...
  dict(role=u"Rappels", lab=u"Confirmer et rappeler",
       ...
       para=u"Les deux messages qui font la différence entre un rendez-vous tenu et une "
            u"matinée perdue. Et si le client ne peut pas, elle replanifie au lieu d'annuler.",
       puces=[('bell', u"Rappel la veille, avec l'heure et l'adresse"),
              ('clock', u"Rappel deux heures avant l'intervention"),
              ('msg', u"Sur le canal que le client utilise vraiment"),
              ('shield', u"Passage en « confirmé » dès qu'il répond"),
              ('loop', u"Replanification proposée en cas d'empêchement")],
...
FACTURATION = dict(
 ...
 cartes=[
  dict(role=u"Émission", lab=u"Sortir la facture",
       ...
       para=u"Le devis devient facture : mêmes lignes, mêmes prix, même client. Vous relisez "
            u"et vous envoyez — il ne part jamais rien sans votre accord.",
       puces=[('doc', u"Facture générée depuis le devis signé"),
              ('bag', u"Facture d'acompte au pourcentage convenu"),
              ('shield', u"Facture de solde, déduction faite de tout le reste"),
              ('loop', u"Avoirs et corrections rattachés à la facture d'origine"),
              ('lock', u"Rien ne part avant votre validation")],
       cta=u"Voir le scénario complet", href=u"#scenario"),
  dict(role=u"Avancement", lab=u"Suivre les chantiers longs",
       ...
       para=u"Sur un chantier de plusieurs mois, c'est là que les erreurs coûtent cher. Le "
            u"cumul et le reste à facturer sont recalculés à chaque situation.",
       puces=[('chart', u"Situations de travaux suivant l'avancement déclaré"),
              ('grille', u"Reste à facturer recalculé à chaque étape"),
              ('doc', u"Retenue de garantie reprise du devis"),
              ('cal', u"Échéances et conditions de paiement posées"),
              ('search', u"Alerte en cas d'écart entre le devis et le facturé")],
  ...
  dict(role=u"Conformité", lab=u"Tenir la réforme",
       ...
       para=u"Une série sans trou, le bon taux de TVA, l'autoliquidation quand elle "
            u"s'applique, et le format électronique attendu par la réforme.",
       puces=[('grid', u"Numérotation continue, sans trou ni doublon"),
              ('grille', u"TVA au bon taux et autoliquidation selon le chantier"),
              ('send', u"Émission au format électronique attendu en 2026"),
              ('info', u"Mentions obligatoires posées automatiquement"),
              ('loop', u"Reprise de votre numérotation là où elle en est")],
  ...
  dict(role=u"Archivage", lab=u"Ranger et transmettre",
       ...
       para=u"Chaque facture reste attachée à son devis et à son chantier. Votre comptable a "
            u"son fichier le dernier jour du mois, dans son format.",
       puces=[('lock', u"Archivage pendant dix ans, facture et devis liés"),
              ('search', u"Recherche par client, par chantier ou par montant"),
              ('grid', u"Export mensuel au format de votre cabinet"),
              ('user', u"Accès en lecture pour votre comptable"),
              ('doc', u"Pièces du chantier rangées au même endroit")],
...
ADMINISTRATIF = dict(
 ...
 cartes=[
  dict(role=u"Tri", lab=u"Vider la boîte",
       ...
       para=u"Demande client, facture fournisseur, administratif, chantier, publicité, sans "
            u"suite. Le démarchage sort de la boîte principale sans disparaître.",
       puces=[('filter', u"Tri en six catégories dès la réception"),
              ('search', u"Extraction des adresses, dates, montants et références"),
              ('grid', u"Mise à l'écart des publicités, sans suppression"),
              ('send', u"Accusé de réception au client, au texte que vous fixez"),
              ('lock', u"Expéditeurs et dossiers exclus sur simple demande")],
       cta=u"Voir le scénario complet", href=u"#scenario"),
  dict(role=u"Résumé", lab=u"Comprendre vite",
       ...
       para=u"Un fil qui s'éternise depuis dix jours se lit en dix secondes. Vous savez ce "
            u"qui a été acté, ce qui coince et ce que le client attend.",
       puces=[('chat', u"Résumé des longs fils, en trois lignes"),
              ('info', u"Ce qui a été décidé, ce qui bloque, ce qu'on attend de vous"),
              ('grille', u"Montants, dates et références sortis du corps du mail"),
              ('user', u"Historique du client rattaché au fil")],
  ...
  dict(role=u"Urgences", lab=u"Faire remonter",
       ...
       para=u"Un chantier bloqué, une relance d'assurance, une échéance qui tombe. Ces "
            u"mails-là ne se perdent pas au milieu des dix-neuf publicités de la nuit.",
       puces=[('bell', u"Détection des urgences chantier et administratives"),
              ('clock', u"Échéances repérées dans le corps du mail"),
              ('star', u"Remontée en haut de pile avec le motif"),
              ('info', u"Rappel des pièces manquantes au dossier")],
  ...
  dict(role=u"Classement", lab=u"Ranger au bon endroit",
       ...
       para=u"Par le client, l'adresse, la référence du devis ou le nom du fichier. En cas de "
            u"doute, elle vous demande plutôt que de deviner — et elle retient la réponse.",
       puces=[('doc', u"Mails et pièces jointes rattachés au bon chantier"),
              ('bag', u"Factures fournisseurs prêtes pour la fin de mois"),
              ('shield', u"Devis, PV de réception et attestations au même endroit"),
              ('search', u"Recherche dans l'historique en langage courant"),
              ('loop', u"Un classement corrigé une fois ne se répète pas")],
